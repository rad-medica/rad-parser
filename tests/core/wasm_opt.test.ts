...
import { initCoreWasm, findSequenceDelimiterWasm, parseDSWasm, parseISWasm } from "../../src/core/wasm-opt";
...
describe("Wasm Optimizations", () => {
    ...
    it("should find sequence delimiter", () => {
        ...
        const buffer = new Uint8Array([
            0x00, 0x01, 0x02, 0xfe, // 0xfe match start
            0xff, 0xff, 0xe0, 0xdd, // not delimiter
            0xfe, 0xff, 0xdd, 0xe0, // Delimiter! at index 8
            0x00, 0x00, 0x00, 0x00
        ]);
